...
const ChartComponent = () => {
    const API_KEY = process.env.APLHA_VANTAGE_API_KEY;
    ...
    const fetchStockData = async (stockSymbol) => {
        ...
        try {
            ...
            if (data["Time Series (Daily)"]) {
                ...
                const prices = labels.map(date => timeSeries[date]["4. close"]).reverse(); // Closing prices
                ...
                console.error("No data found for the symbol.");
            }
        } catch (error) {
